...
public class NestedBeanProcessor extends BeanProcessor {
    ...
    protected Object processColumn(ResultSet rs, int index, Class<?> propType)
        ...
        if ( !propType.isPrimitive() && rs.getObject(index) != null ) {
            if (List.class.isAssignableFrom(propType)) {
                return xstream.fromXML(rs.getString(index));
            }
        }
        return _processColumn(rs, index, propType);
    }
     ...
     * @since 1.5
     */
    public NestedBeanProcessor(Map<String, String> columnToPropertyOverrides) {
        super();
    ...
    public <T> T toBean(ResultSet rs, Class<T> type) throws SQLException {
        ...
        return this._createBean(rs, type, props, columnToProperty);
    }
    ...
    public <T> List<T> toBeanList(ResultSet rs, Class<T> type) throws SQLException {
        ...
        do {
            results.add(this._createBean(rs, type, props, columnToProperty));
        } while (rs.next());
     ...
     */
    private <T> T _createBean(ResultSet rs, Class<T> type,
        ...
        for (int i = 1; i < columnToProperty.length; i++) {
            ...
            this._callSetter(bean, prop, value);
        }
     ...
     */
    private void _callSetter(Object target, PropertyDescriptor prop, Object value)
            throws SQLException {
     ...
     * value was SQL NULL.
     */
    protected Object _processColumn(ResultSet rs, int index, Class<?> propType)
        throws SQLException {
